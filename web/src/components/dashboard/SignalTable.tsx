...
export const SECTOR_COLORS: Record<string, string> = {
  ...
  Industrials: "bg-slate-400/15 text-slate-400 border-slate-400/30",
  "Communication Services": "bg-purple-500/15 text-purple-400 border-purple-500/30",
  "Real Estate": "bg-rose-500/15 text-rose-400 border-rose-500/30",
  Utilities: "bg-teal-500/15 text-teal-400 border-teal-500/30",
  Materials: "bg-yellow-500/15 text-yellow-400 border-yellow-500/30",
  "Basic Materials": "bg-yellow-500/15 text-yellow-400 border-yellow-500/30",
};
    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
      ...
      {Array.from({ length: 12 }).map((_, i) => (
        ...
        >
          ...
          <div className="w-14 h-5 bg-zinc-800/50 rounded-md animate-pulse hidden lg:block" />
